...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { age: @child.age, bio: @child.bio, first_name: @child.first_name, last_name: @child.last_name, sex: @child.sex }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { age: @child.age, bio: @child.bio, first_name: @child.first_name, last_name: @child.last_name, sex: @child.sex }
    assert_redirected_to child_path(assigns(:child))
  end
