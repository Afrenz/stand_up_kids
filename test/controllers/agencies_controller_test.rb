...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { city: @agency.city, email: @agency.email, name: @agency.name, state: @agency.state }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { city: @agency.city, email: @agency.email, name: @agency.name, state: @agency.state }
    assert_redirected_to agency_path(assigns(:agency))
  end
